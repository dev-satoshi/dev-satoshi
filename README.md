...
# Languages＆Tools
[![My Skills](https://skillicons.dev/icons?i=html,css,sass,js,ts,python,ruby,dart,react,nextjs,django,flask,rails,flutter,tailwind,bootstrap)](https://skillicons.dev)<br>
